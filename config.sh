...
declare -A FQBN_TARGETS=(
    ...
    ["esp32s3-ble-bridge"]="esp32:esp32:esp32s3:FlashSize=4M,PSRAM=enabled,PartitionScheme=min_spiffs,USBMode=hwcdc,CDCOnBoot=cdc" # ESP32-S3 Zero e-paper BLE bridge (headless, mains-powered, native USB CDC, 2MB QSPI PSRAM)
