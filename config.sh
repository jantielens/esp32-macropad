...
declare -A FQBN_TARGETS=(
    ...
    ["inkplate5v2"]="Inkplate_Boards:esp32:Inkplate5V2:PartitionScheme=ota_3mb_8MB" # Soldered Inkplate 5V2 (ESP32 classic, 5.17" 720x1280 3-bit grayscale e-paper; 8MB + 4MB QSPI PSRAM)
)
