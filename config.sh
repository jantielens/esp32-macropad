...
declare -A FQBN_TARGETS=(
    ...
    ["inkplate6flick"]="Inkplate_Boards:esp32:Inkplate6Flick:PartitionScheme=min_spiffs" # Soldered Inkplate 6FLICK (ESP32 classic, 6.0" 1024x758 3-bit grayscale e-paper touchscreen + frontlight; 4MB flash + 8MB PSRAM). min_spiffs = 1.9MB APP with OTA (6FLICK variant has no ota_1_9mb scheme)
        ["inkplate6flick-lvgl"]="Inkplate_Boards:esp32:Inkplate6Flick:PartitionScheme=huge_app" # Experimental Inkplate 6FLICK always-on LVGL grayscale UI; 3MB no-OTA application partition
        ["inkplate6flick-lvgl-bw"]="Inkplate_Boards:esp32:Inkplate6Flick:PartitionScheme=huge_app" # Experimental Inkplate 6FLICK always-on LVGL B/W partial-update UI; 3MB no-OTA application partition
