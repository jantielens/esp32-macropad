...
declare -A FQBN_TARGETS=(
    ...
    ["jc4880p433-hx711"]="esp32:esp32:esp32p4:FlashSize=16M,PSRAM=enabled,PartitionScheme=ota_6mb_16MB,USBMode=hwcdc,CDCOnBoot=cdc" # JC4880P433 + HX711 coffee scale
    ["jc4880p433-nau7802"]="esp32:esp32:esp32p4:FlashSize=16M,PSRAM=enabled,PartitionScheme=ota_6mb_16MB,USBMode=hwcdc,CDCOnBoot=cdc" # JC4880P433 + NAU7802 coffee scale
