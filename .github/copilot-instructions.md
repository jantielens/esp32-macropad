...
- **BLE HID Subsystem**: Bluetooth LE keyboard with key sequence DSL (compile-time gated by `HAS_BLE_HID`; runtime-toggled via `ble_enabled` config, default disabled, saves ~70 KB internal RAM when off)
