...
// MSFT RS256 CA-1, the issuing CA for Azure AI Foundry services.ai.azure.com
// endpoints. Public trust material; valid through 2032-04-27.
constexpr char VOICE_AZURE_CA_CERT[] =
    "-----BEGIN CERTIFICATE-----\n"
