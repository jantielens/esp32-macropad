#ifndef EPAPER_FRAME_SCHEDULE_H
#define EPAPER_FRAME_SCHEDULE_H
...
static const uint64_t EPAPER_FRAME_SCHEDULE_MIN_VALID_EPOCH = 946684800;
...
bool epaper_frame_schedule_should_refresh(uint32_t hour_bitmask, int8_t tz_offset, uint64_t utc_epoch);
...
uint32_t epaper_frame_schedule_seconds_to_next(uint32_t hour_bitmask, int8_t tz_offset, uint64_t utc_epoch);

#endif // IS_EPAPER_FRAME

#endif // EPAPER_FRAME_SCHEDULE_H
