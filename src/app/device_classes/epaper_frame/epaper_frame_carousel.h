#ifndef EPAPER_FRAME_CAROUSEL_H
#define EPAPER_FRAME_CAROUSEL_H
...
uint8_t epaper_frame_carousel_next_index(uint8_t current, uint8_t count, bool stay);

#endif // IS_EPAPER_FRAME

#endif // EPAPER_FRAME_CAROUSEL_H
