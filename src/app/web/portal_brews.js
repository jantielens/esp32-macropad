...
async function brewTmplShowDetail(name) {
    try {
        ...
        document.getElementById('brew-list-view').style.display = 'none';
        document.getElementById('brew-detail-view').style.display = 'none';
        document.getElementById('brew-tmpl-section').style.display = 'none';
        document.getElementById('brew-tmpl-detail-view').style.display = 'block';
        window.scrollTo(0, 0);
    } catch (err) {
...
function brewTmplBackToList() {
    document.getElementById('brew-tmpl-detail-view').style.display = 'none';
    document.getElementById('brew-list-view').style.display = '';
    document.getElementById('brew-detail-view').style.display = 'none';
    document.getElementById('brew-tmpl-section').style.display = '';
}
