...
// Suppress visual transitions on slow-refresh displays while preserving state updates.
#ifndef DISPLAY_DISABLE_ANIMATIONS
#define DISPLAY_DISABLE_ANIMATIONS false
#endif

// Wall-clock-aligned interval between passive pad binding refreshes; 0 keeps every LVGL-cycle refresh.
#ifndef DISPLAY_BINDING_REFRESH_INTERVAL_MS
...
#endif
// Maximum permitted passive e-paper binding refresh interval.
#ifndef EPAPER_BINDING_REFRESH_INTERVAL_MAX_MS
...
// Allocate display render and presentation task stacks in PSRAM when supported.
// Disable on targets whose FreeRTOS port rejects external static task stacks.
#ifndef LVGL_TASK_USE_PSRAM_STACK
#define LVGL_TASK_USE_PSRAM_STACK true
#endif

// Select the default LVGL theme brightness. E-paper targets typically use a
// light theme to avoid a full-screen black background.
#ifndef LVGL_THEME_DARK_MODE
#define LVGL_THEME_DARK_MODE true
#endif
...
//   TOUCH_DRIVER_INKPLATE6FLICK (7) - InkplateLibrary Cypress touch (experimental)
