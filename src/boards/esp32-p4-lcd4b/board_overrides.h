...
#define DISPLAY_PANEL "ST7703"
#define TOUCH_DRIVER TOUCH_DRIVER_GT911

// ============================================================================
// Pad Layout
// ============================================================================
#define DISPLAY_SHAPE DISPLAY_SHAPE_SQUARE
...
#define AUDIO_I2S_DIN    11   // ESP32 RX ← ES7210 SDOUT2 (microphone ADC output)
#define AUDIO_PA_PIN     53   // NS4150B power amplifier enable (active high)
#define AUDIO_CODEC_ADDR 0x18 // ES8311 I2C address
#define AUDIO_MIC_ADC_ADDR   0x40 // ES7210 I2C address
