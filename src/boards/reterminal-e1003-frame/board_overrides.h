...
// Project branding is derived from device class (HAS_EPAPER_PANEL/HAS_DISPLAY)
...
#define HAS_BUTTON false  // see HAS_EPAPER_FRAME_WAKE_BUTTON below for the e-paper-specific wake handler
...
// and SD_DET reads LOW when a card is inserted. Defining EPAPER_FRAME_SD_CS_PIN
// compiles in the optional SD image cache in the E-Paper Frame driver, which lets a
...
#define HAS_EPAPER_FRAME_WAKE_BUTTON true
#define EPAPER_FRAME_BUTTON_PIN 3
...
#define EPAPER_FRAME_BATTERY_ENABLE_PIN 40
// Voltage divider ratio applied to the raw ADC millivolt reading.
#define EPAPER_FRAME_BATTERY_DIVIDER 2.0f
...
#define EPAPER_FRAME_FAST_REFRESH true
...
#define PORTAL_PRIMARY_CATEGORY "epaper_frame"
