...
// ==========================================================================
// Board Overrides: inkplate6flick-frame (Soldered Inkplate 6FLICK)
// ==========================================================================
...
// Project branding is derived from device class (HAS_EPAPER_PANEL/HAS_DISPLAY) via
...
#define PORTAL_PRIMARY_CATEGORY "epaper-frame"
#define PORTAL_PRIMARY_LABEL    "E-Paper Frame"
