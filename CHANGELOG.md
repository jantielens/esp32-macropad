...
- **Guition JC1060P470C board support** — new ESP32-P4 board with 7.0" 1024×600 IPS display (JD9165 MIPI-DSI driver), GT911 capacitive touch, and ES8311 + NS4150B audio. Adds `jd9165_dsi_driver` display backend.
