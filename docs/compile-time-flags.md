...
| board-name | HAS_AUDIO | HAS_BACKLIGHT | HAS_BLE_HID | HAS_BUILTIN_LED | HAS_BUTTON | HAS_CUSTOM_FONTS | HAS_DISPLAY | HAS_IMAGE_FETCH | HAS_MQTT | HAS_SENSOR_BME280 | HAS_SENSOR_DUMMY | HAS_SENSOR_HX711 | HAS_SENSOR_LD2410_OUT | HAS_SENSOR_NAU7802 | HAS_SOUND_PLAYER | HAS_TOUCH |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| esp32-4848S040 |  | ✅ |  |  |  | ? | ✅ | ? | ✅ |  |  |  |  |  | ? | ✅ |
| jc3248w535 |  | ✅ |  |  |  | ? | ✅ | ? | ✅ |  |  |  |  |  | ? | ✅ |
| jc3636w518 |  | ✅ |  |  |  | ? | ✅ | ? | ✅ |  |  |  |  |  | ? | ✅ |
