...
- **HAS_AUDIO_INPUT** default: `false` — Enable board-selected PCM microphone input support.
...
- **HAS_CAMERA** default: `false` — Enable onboard camera hardware support.
- **HAS_CONFIG_MODE_BUTTON** default: `HAS_BUTTON` — Enables a boot-hold button to enter configuration mode without runtime actions.
...
- **HAS_EPAPER_FRAME_WAKE_BUTTON** default: `false` — Enable e-paper wake-button handling (ext1 wake plus short/long press).
- **HAS_EPAPER_FRONTLIGHT** default: `false` — Enable e-paper frontlight control on boards with frontlight hardware.
- **HAS_EPAPER_PANEL** default: `false` — Board has a physical e-paper panel.
...
- **EPAPER_FRAME_BATTERY_ADC_PIN** default: `(no default)` — ADC pin for the battery sense divider (GPIO1 on the E1003).
- **EPAPER_FRAME_BATTERY_ENABLE_PIN** default: `(no default)` — Drive HIGH ~5ms before sampling to gate the battery divider on (GPIO40 on E1003).
- **EPAPER_FRAME_BUTTON_PIN** default: `36` — (typical Inkplate wiring uses GPIO36 with an external pullup).
- **EPAPER_FRAME_SD_CS_PIN** default: `(no default)` — default; enable via the portal (Image & Schedule -> "Cache images on SD").
- **EPAPER_FRAME_SD_DET_PIN** default: `(no default)` — microSD card-detect input (reads LOW when a card is inserted).
- **EPAPER_FRAME_SD_EN_PIN** default: `(no default)` — microSD power-enable gate (drive HIGH ~5 ms before mounting the card).
...
- **EPAPER_MIN_REFRESH_INTERVAL_MS** default: `(no default)` — A short floor prevents action-driven partial-update bursts.
- **EPAPER_REFRESH_INTERVAL_MAX_MS** default: `60000` — Maximum permitted physical e-paper presentation interval.
- **EPAPER_REFRESH_INTERVAL_MIN_MS** default: `250` — Minimum permitted physical e-paper presentation interval.
...
- **AUDIO_MIC_ADC_ADDR** default: `0x40` — I2C address of the microphone ADC (e.g. ES7210 = 0x40).
...
- **CAMERA_CSI_DATA_LANES** default: `0` — Camera CSI data lane count.
- **CAMERA_CSI_LANE_BIT_RATE_MBPS** default: `0` — Camera CSI lane bit rate in Mbps.
- **CAMERA_SCCB_ADDR** default: `0x00` — Camera sensor SCCB/I2C address.
...
- **IS_EPAPER_FRAME** default: `false` — Select the sleep-first E-Paper Frame product class.
...
| board-name | AUDIO_OUTPUT_DRIVER | CAMERA_DRIVER | DISPLAY_DRIVER | TOUCH_DRIVER |
| --- | --- | --- | --- | --- |
| esp32-4848S040 | AUDIO_OUTPUT_DRIVER_ES8311 | CAMERA_DRIVER_NONE | DISPLAY_DRIVER_ST7701_RGB | TOUCH_DRIVER_GT911 |
...
| jc4880p433-sd | AUDIO_OUTPUT_DRIVER_ES8311 | CAMERA_DRIVER_OV02C10_P4 | DISPLAY_DRIVER_ST7701_DSI | TOUCH_DRIVER_GT911 |
| jc4880p433-shutter | AUDIO_OUTPUT_DRIVER_ES8311 | CAMERA_DRIVER_OV02C10_P4 | DISPLAY_DRIVER_ST7701_DSI | TOUCH_DRIVER_GT911 |
...
| inkplate5v2-frame | AUDIO_OUTPUT_DRIVER_ES8311 | CAMERA_DRIVER_NONE | — | — |
...
- **HAS_AUDIO_INPUT**
  ...
  - src/app/drivers/pcm510xa_audio_driver.cpp
- **HAS_BACKLIGHT**
  - src/app/app.ino
  - src/app/board_config.h
...
- **HAS_BUTTON**
  ...
  - src/app/actions/screen_action.cpp
  - src/app/actions/sound_alert_action.cpp
  - src/app/actions/system_action.cpp
...
- **HAS_EPAPER_FRAME_WAKE_BUTTON**
  - src/app/board_config.h
  - src/app/device_classes/epaper_frame/epaper_frame_config.h
  - src/app/device_classes/epaper_frame_device_class.cpp
- **HAS_EPAPER_FRONTLIGHT**
  - src/app/board_config.h
  - src/app/device_classes/epaper_frame/drivers/inkplate_driver.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_driver.h
  - src/app/device_classes/epaper_frame_device_class.cpp
- **HAS_EPAPER_PANEL**
  - src/app/board_config.h
- **HAS_EPAPER_VCOM**
  - src/app/board_config.h
  - src/app/device_classes/epaper_frame/components/epaper_vcom_component.cpp
- **HAS_ES7210_MIC**
  - src/app/board_config.h
  - src/app/drivers/es8311_audio_driver.cpp
- **HAS_HA_HISTORY**
...
- **HAS_MQTT**
  ...
  - src/app/data_stream.cpp
  - src/app/data_stream.h
  - src/app/device_classes/epaper_frame/epaper_frame_mqtt.cpp
...
- **HAS_NATIVE_EXTENSIONS**
  - src/app/app.ino
  - src/app/board_config.h
  - src/app/components/extensions_component.cpp
...
- **CAMERA_SCCB_ADDR**
  - src/app/board_config.h
- **CAMERA_SENSOR_EXPECTED_ID**
  - src/app/board_config.h
- **CAMERA_SENSOR_ID_REG_HIGH**
  - src/app/board_config.h
- **CONFIG_ASYNC_TCP_STACK_SIZE**
  - src/app/web_portal.cpp
...
- **EPAPER_DEFAULT_RENDER_MODE**
  - src/app/board_config.h
- **EPAPER_FRAME_BATTERY_ADC_PIN**
  - src/app/device_classes/epaper_frame/drivers/reterminal_e1003_driver.cpp
- **EPAPER_FRAME_BATTERY_DIVIDER**
  - src/app/device_classes/epaper_frame/drivers/reterminal_e1003_driver.cpp
- **EPAPER_FRAME_BATTERY_ENABLE_PIN**
  - src/app/device_classes/epaper_frame/drivers/reterminal_e1003_driver.cpp
- **EPAPER_FRAME_BUTTON_PIN**
  - src/app/board_config.h
- **EPAPER_FRAME_FAST_REFRESH**
  - src/app/board_config.h
- **EPAPER_FRAME_SD_CS_PIN**
  - src/app/device_classes/epaper_frame/drivers/reterminal_e1003_driver.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_sd_cache.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_sd_cache.h
  - src/app/device_classes/epaper_frame_device_class.cpp
...
- **IS_EPAPER_FRAME**
  ...
  - src/app/device_class_registry.cpp
  - src/app/device_classes.cpp
  - src/app/device_classes/epaper_frame/components/epaper_image_component.cpp
  - src/app/device_classes/epaper_frame/components/epaper_overlay_component.cpp
  - src/app/device_classes/epaper_frame/components/epaper_status_component.cpp
  - src/app/device_classes/epaper_frame/components/epaper_vcom_component.cpp
  - src/app/device_classes/epaper_frame/drivers/inkplate_driver.cpp
  - src/app/device_classes/epaper_frame/drivers/reterminal_e1003_driver.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_carousel.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_carousel.h
  - src/app/device_classes/epaper_frame/epaper_frame_config.h
  - src/app/device_classes/epaper_frame/epaper_frame_crc32.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_crc32.h
  - src/app/device_classes/epaper_frame/epaper_frame_driver.h
  - src/app/device_classes/epaper_frame/epaper_frame_drivers.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_http.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_http.h
  - src/app/device_classes/epaper_frame/epaper_frame_mqtt.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_mqtt.h
  ...
  - src/app/device_classes/epaper_frame/epaper_frame_refresh.h
  - src/app/device_classes/epaper_frame/epaper_frame_schedule.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_schedule.h
  - src/app/device_classes/epaper_frame/epaper_frame_screens.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_screens.h
  - src/app/device_classes/epaper_frame/epaper_frame_sd_cache.cpp
  - src/app/device_classes/epaper_frame/epaper_frame_sd_cache.h
  - src/app/device_classes/epaper_frame/epaper_frame_timing.cpp
